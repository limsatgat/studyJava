...
//
//        System.out.println("생년월일 8자리를 입력하면 육십갑자와 요일이 출력됩니다. ex) 1999년1월1일 또는 1994년01월01일");
//        StringBuilder birthS = new StringBuilder(inputValue.next());
//        String birth = (String)birthS;
//
//
////        int birthMonth = Integer.parseInt(birthS.substring(5,6));
////        int birthDay = Integer.parseInt(birthS.substring(7,8));
////
////        if(birthMonth < 1 || birthDay < 1 || birthMonth > 9 || birthDay > 9){
////            System.out.println("잘못된 입력입니다.");
////            inputValue.next();
////        }
////
////        if (birthMonth < 10) {
////            birthS.replace(5, 5, "0" + birthS.substring(5, 5));
////            System.out.println(birthS);
////        }
////        if (birthDay < 10) {
////            birthS.replace(8, 8, "0" + birthS.substring(8, 8));
////            System.out.println(birthS);
////        }
//
